...
public class Grafico {
    public static void Graficar(String fecha){
        ...
        try {
            ...
            JFreeChart jf = ChartFactory.createPieChart("Reporte de Venta", dataset);   //  El primero es el nombre del reporte
            ChartFrame f = new ChartFrame("Total de ventas por día", jf);
            f.setSize(1000, 500);   //  Pone el tamaño anchura y altura
