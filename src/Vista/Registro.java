...
public class Registro extends javax.swing.JFrame {
    ...
    public void validar() {
        ...
        if (!"".equals(correo) || !"".equals(pass) || !"".equals(nom)) {
            ...
            lg.setRol(rol);
            login.Registrar(lg);
            Login iniciar = new Login();  //  Después de registrar un usuario de abre la vista Login
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(358, 20, 330, 420));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 6, 500, 450));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/login.jpg"))); // NOI18N
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(498, -24, 240, 510));
